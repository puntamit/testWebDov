                                            ...
                                            <td className="bg-white p-2 border-y border-transparent group-hover:border-slate-100 transition-all duration-300">
                                                <div className="flex justify-center">
                                                    <input
                                                        ...
                                                        className="w-12 h-10 text-center bg-slate-50/50 rounded-xl border-2 border-transparent focus:border-blue-500 focus:bg-white outline-none text-lg font-black text-blue-600 transition-all duration-300 shadow-inner"
                                                        required
                                                    />
                                                </div>
                                            </td>
