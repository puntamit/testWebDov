...
const TransactionReceipt: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-100 p-4 sm:p-8 flex flex-col items-center gap-10 print:gap-0 print:p-0">
            ...
            {itemChunks.map((chunk, chunkIndex) => (
                <div
                    key={chunkIndex}
                    className="bg-white w-full max-w-[210mm] h-auto lg:h-[282mm] p-[6mm] sm:p-[15mm] shadow-2xl print:shadow-none print:p-[12mm] flex flex-col receipt-page-container box-border"
                    style={{
                ...
                >
                    ...
                    <div className="flex justify-between items-start border-b-2 border-black pb-4 mb-6">
                        ...
                        <div className="text-right">
                            <div className="text-sm font-black text-slate-900 leading-tight">เลขที่เอกสาร: {tx.docNo}</div>
                            <div className="text-[9px] font-bold text-slate-600">วันที่: {new Date(tx.date).toLocaleDateString('th-TH')}</div>
                        </div>
                    </div>
